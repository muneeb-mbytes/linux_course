...
#--------------------------------------------------------------------------------------------
echo $RED"Command: find [where_to_find] [-options] [what_to_find] [-option] command"$NC
echo ""
echo $RED"Description: This command is used to find and delete the files and directories"$NC
echo ""
