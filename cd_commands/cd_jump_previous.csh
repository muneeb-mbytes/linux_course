...
echo $RED"This is the path of the directory what i entered by using cd fruits/apple/banana"$NC
pwd
echo ""
cd -
...
if ("$userinput" == "cd -") then
    ...
    echo ""
    cd fruits/apple/banana
    echo $GREEN"This is the path of the directory what i entered by using cd fruits/apple/banana"$NC
    pwd
    echo ""
    $userinput
